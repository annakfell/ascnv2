...
:::{.callout-note}
#### Packages Used
This chapter uses the following packages: `ggplot2`, [sjPlot](https://strengejacke.github.io/sjPlot/), `gtsummary`, `waffle`, `ggpubr`, `ggridges`, `scales`, `gridExtra` and the [penguins](https://allisonhorst.github.io/palmerpenguins/index.html) data. 
:::
