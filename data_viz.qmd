...
You will see, and slowly learn, how to add these annotations and how to clean up your graphics to make them shareable. `ggplot2` already does a lot of this work for you. 
...
As time permits I will update each section with a third type of plot - 
  ...
  3. Shareable - Contains all bells and whistles needed to make it presentable to others. 
...
* `aes()`: This is the _aesthetics_ of the plot. What's variable is on the x, what is on 
